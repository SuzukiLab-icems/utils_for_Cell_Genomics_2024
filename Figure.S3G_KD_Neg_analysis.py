...
for values in factors:
	...
	for target in ["Ovol2","Rnf215","Cldn34c4","Rd3","Cebpg","Rbm26","P2ry2"]:
		...
		try:
			...
			with open("./Figure.S3G_KD_Neg_Fluo4-AM/Figure.S3G_KD_Neg_stats.txt", "a", encoding='utf-8', newline='\n') as f:
	...
	plt.tight_layout()
	plt.savefig(f'./Figure.S3G_KD_Neg_Fluo4-AM/Figure.S3G_KD_{values}.eps', dpi=300)
	plt.savefig(f'./Figure.S3G_KD_Neg_Fluo4-AM/Figure.S3G_KD_{values}.png', dpi=300)
	plt.close()
