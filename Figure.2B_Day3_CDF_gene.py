...
#import files
df1 = pd.read_csv("./F2-1_1_D3N3/mageck_result/D3N3_SUM.csv", index_col=0)
df2 = pd.read_csv("./F2-2_1_D3N9/mageck_result/D3N9_SUM.csv", index_col=0)
...
df1_fix.to_csv('Figure.2B_Day3_N3_gene.csv')
df2_fix.to_csv('Figure.2B_Day3_N9_gene.csv')
df5_fix.to_csv('Figure.2B_INPUT_gene.csv')
...
df1_log2_CPM.to_csv('Figure.2B_Day3_N3_normalized_gene.csv')

df2_CPM = 10**6 * df2_fix / sum_df2
df2_log2_CPM = np.log2(df2_CPM)
df2_log2_CPM.to_csv('Figure.2B_Day3_N9_normalized_gene.csv')

df5_CPM = 10**6 * df5_fix / sum_df5
df5_log2_CPM = np.log2(df5_CPM)
df5_log2_CPM.to_csv('Figure.2B_INPUT_normalized_gene.csv')

#cumulative distribution fraction
df_x1 = pd.read_csv("Figure.2B_Day3_N3_normalized_gene.csv")
df_x2 = pd.read_csv("Figure.2B_Day3_N9_normalized_gene.csv")
df_x5 = pd.read_csv("Figure.2B_INPUT_normalized_gene.csv")
...
df_merge.to_csv("Figure.2B_merge_gene.csv")
df_merge = pd.read_csv("Figure.2B_merge_gene.csv")
...
plt.savefig("Figure.2B_Day3_gene.eps",format='eps',dpi=300)
plt.savefig("Figure.2B_Day3_gene.png",format='png',dpi=300)
